                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="username"
                        value="<?php echo $userInfo['username']; ?>" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="contact_number"
                        value="<?php echo $userInfo['contact_number']; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="#">Bio</label>
                      <textarea name="bio_description"
                        class="form-control"><?php echo $userInfo['bio_description']; ?></textarea>
                    </div>
                    <div class="form-group">
