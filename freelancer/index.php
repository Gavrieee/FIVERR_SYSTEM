...
<body>
  ...
  <div class="container-fluid">
    <div class="display-4 text-center">Hello there and welcome! <span
        class="text-success"><?php echo $_SESSION['username']; ?></span>. Add Proposal Here!</div>
    <div class="row">
      <div class="col-md-5">
        ...
        <?php foreach ($getProposals as $proposal) { ?>
          <div class="card shadow mt-4 mb-4">
            <div class="card-body">
              ...
              <h2><a
                  href="<?= $_SESSION['user_id'] == $proposal['user_id'] ? 'profile.php' : 'other_profile_view.php?user_id=' . $proposal['user_id'] ?>">
